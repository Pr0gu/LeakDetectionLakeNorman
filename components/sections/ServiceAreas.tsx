...
export default function ServiceAreas() {
  ...
  return (
    <section id="areas" className="section-padding bg-brand-ice" aria-labelledby="areas-heading">
      <div className="container-narrow">
        ...
        >
          ...
          <h2 id="areas-heading" className="text-balance text-3xl font-extrabold text-brand-deep sm:text-4xl md:text-5xl">
  ...
  return (
    <div
      ...
      className={`group flex items-center gap-2.5 rounded-xl border bg-white px-4 py-3.5 shadow-sm transition-all duration-500 hover:-translate-y-0.5 hover:shadow-md ${
        area.primary
          ...
          : 'border-brand-deep/10 hover:border-brand-accent/20'
    ...
    >
      <MapPin
        ...
        aria-hidden="true"
      />
      <span className={`text-sm font-semibold ${area.primary ? 'text-brand-deep' : 'text-gray-700'}`}>
        {area.name}
      </span>
    </div>
  );
